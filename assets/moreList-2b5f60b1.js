import { _ as _export_sfc, E as useRoute, u as useRouter, i as inject, r as ref, f as useMsgStore, o as onMounted, a as openBlock, c as createElementBlock, d as createBaseVNode, t as toDisplayString, g as unref, n as normalizeStyle, F as Fragment, b as renderList, h as createVNode, w as withCtx, T as Transition, e as createBlock, k as withDirectives, v as vShow, m as createTextVNode, j as createCommentVNode, p as pushScopeId, l as popScopeId } from "./index-a0fe60eb.js";
import { n as noteCard } from "./noteCard-893894b1.js";
const moreList_vue_vue_type_style_index_0_scoped_d1ee097d_lang = "";
const _withScopeId = (n) => (pushScopeId("data-v-d1ee097d"), n = n(), popScopeId(), n);
const _hoisted_1 = {
  class: "moreList"
};
const _hoisted_2 = {
  ...
  setup(__props) {
    ...
    const handleScroll = function(event) {
      ...
      if (endi >= blogs.value.length) {
        paddingTop.value = listHeight.value;
        endi = blogs.value.length - 1;
        starti = endi - count;
      }
      paddingTop.value = starti * cardsize;
      paddingBottom.value = (blogs.value.length - 1 - endi) * cardsize;
      showBlogs.value = blogs.value.slice(starti, endi + 1);
    };
...
const moreList = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d1ee097d"]]);
export {
  moreList as default
};
