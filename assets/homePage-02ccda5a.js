import { _ as _export_sfc, u as useRouter, i as inject, r as ref, o as onMounted, a as openBlock, c as createElementBlock, b as renderList, d as createBaseVNode, t as toDisplayString, F as Fragment, e as createBlock, f as useMsgStore, n as normalizeStyle, g as unref, h as createVNode, w as withCtx, T as Transition, j as createCommentVNode, k as withDirectives, v as vShow, p as pushScopeId, l as popScopeId, m as createTextVNode } from "./index-fe9d6c27.js";
import { r as rightSum } from "./rightSum-2586f98a.js";
import { n as noteCard } from "./noteCard-1b9612ab.js";
const _imports_0 = "/images/bg_pic2.jpg";
...
const homePage_vue_vue_type_style_index_0_scoped_8bcf1498_lang = "";
const _withScopeId = (n) => (pushScopeId("data-v-8bcf1498"), n = n(), popScopeId(), n);
const _hoisted_1 = {
  class: "homePage"
};
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [createBaseVNode("div", _hoisted_1, [_hoisted_2, createBaseVNode("div", {
        ...
        class: "start",
        onClick: turnToNext
      }, "开始阅读")) : createCommentVNode("", true)]), createBaseVNode("div", _hoisted_11, [createBaseVNode("div", _hoisted_12, [createVNode(noteList)]), createBaseVNode("div", _hoisted_13, [createVNode(rightSum)])]), createBaseVNode("img", {
        class: "bg",
        src: _imports_0,
        alt: "",
        ref_key: "bg",
...
const homePage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8bcf1498"]]);
export {
  homePage as default
};
