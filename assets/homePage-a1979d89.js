import { _ as _export_sfc, u as useRouter, i as inject, r as ref, o as onMounted, a as openBlock, c as createElementBlock, b as renderList, d as createBaseVNode, t as toDisplayString, F as Fragment, e as createBlock, f as useMsgStore, n as normalizeStyle, g as unref, h as createVNode, w as withCtx, T as Transition, j as createCommentVNode, k as withDirectives, v as vShow, p as pushScopeId, l as popScopeId, m as createTextVNode } from "./index-5b4d7308.js";
import { r as rightSum } from "./rightSum-9cb5b695.js";
import { n as noteCard } from "./noteCard-121037b2.js";
...
const homePage_vue_vue_type_style_index_0_scoped_b6ca0a58_lang = "";
const _withScopeId = (n) => (pushScopeId("data-v-b6ca0a58"), n = n(), popScopeId(), n);
const _hoisted_1 = {
  class: "homePage"
};
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [createBaseVNode("div", _hoisted_1, [_hoisted_2, createBaseVNode("div", {
        ...
        class: "start",
        onClick: turnToNext
      }, "开始阅读")) : createCommentVNode("", true)]), createBaseVNode("div", _hoisted_11, [createBaseVNode("div", _hoisted_12, [createVNode(noteList)]), createBaseVNode("div", _hoisted_13, [createVNode(rightSum)])]), withDirectives(createBaseVNode("img", {
        class: "bg",
        src: _imports_0,
        alt: "",
        ref_key: "bg",
        ref: bg
      }, null, 512), [[vShow, unref(ifShow)]]), withDirectives(createBaseVNode("div", _hoisted_14, null, 512), [[vShow, !unref(ifShow)]])], 64);
    };
  }
};
const homePage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b6ca0a58"]]);
export {
  homePage as default
};
