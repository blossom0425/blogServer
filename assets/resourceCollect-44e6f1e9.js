import { _ as _export_sfc, A as reactive, a as openBlock, c as createElementBlock, d as createBaseVNode, t as toDisplayString, F as Fragment, b as renderList, h as createVNode, w as withCtx, j as createCommentVNode, T as Transition, g as unref, p as pushScopeId, l as popScopeId, r as ref, x as normalizeClass, s as isRef, e as createBlock, B as resolveDynamicComponent } from "./index-de877cc2.js";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$4, [createBaseVNode("h2", _hoisted_2$2, toDisplayString(__props.title), 1), createBaseVNode("div", {
        ...
        return openBlock(), createElementBlock("div", {
          ...
          default: withCtx(() => [item.show && item.imgSrc ? (openBlock(), createElementBlock("img", {
            key: 0,
            src: item.imgSrc,
            alt: "",
            class: "preview"
...
const resourceComponent = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-de8a9c0f"]]);
const _hoisted_1$3 = {
  class: "webDesign"
};
const _sfc_main$5 = {
