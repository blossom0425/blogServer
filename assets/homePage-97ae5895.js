import { _ as _export_sfc, u as useRouter, i as inject, r as ref, o as onMounted, a as openBlock, c as createElementBlock, b as renderList, d as createBaseVNode, t as toDisplayString, F as Fragment, e as createBlock, f as useMsgStore, w as withDirectives, v as vShow, g as unref, n as normalizeStyle, h as createVNode, j as withCtx, T as Transition, k as createCommentVNode, p as pushScopeId, l as popScopeId, m as createTextVNode } from "./index-2fd890bf.js";
import { r as rightSum } from "./rightSum-e2430897.js";
import { n as noteCard } from "./noteCard-7d2abb2e.js";
const _imports_0 = "/assets/bg_pic2-4a2ecac1.jpg";
const noteList_vue_vue_type_style_index_0_scoped_89983c16_lang = "";
const _hoisted_1$1 = {
...
const noteList = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-89983c16"]]);
const homePage_vue_vue_type_style_index_0_scoped_5560ae6f_lang = "";
const _withScopeId = (n) => (pushScopeId("data-v-5560ae6f"), n = n(), popScopeId(), n);
const _hoisted_1 = {
  class: "homePage"
};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [withDirectives(createBaseVNode("div", _hoisted_1, [_hoisted_2, createBaseVNode("div", {
        class: "title",
        ...
        class: "start",
        onClick: turnToNext
      }, "开始阅读")) : createCommentVNode("", true)], 512), [[vShow, unref(ifShow)]]), unref(ifShow) ? (openBlock(), createElementBlock("div", _hoisted_11, [createBaseVNode("div", _hoisted_12, [createVNode(noteList)]), createBaseVNode("div", _hoisted_13, [createVNode(rightSum)])])) : createCommentVNode("", true), withDirectives(createBaseVNode("img", {
        class: "bg",
        src: _imports_0,
        alt: "",
        ref_key: "bg",
        ref: bg
      }, null, 512), [[vShow, unref(ifShow)]])], 64);
    };
  }
};
const homePage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5560ae6f"]]);
export {
  homePage as default
};
